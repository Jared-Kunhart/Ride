...
class Booking(db.Model):
    ...
    origin = db.relationship("Marker", back_populates="origin_id", cascade='all,delete-orphan', foreign_keys=[origin_id])
    destination = db.relationship("Marker", back_populates="destination_id", cascade='all,delete-orphan', foreign_keys=[destination_id])
